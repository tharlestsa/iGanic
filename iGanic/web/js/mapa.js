    ...
    $.getJSON('./data/fornecedores.json', function (pontos) {
        ...
        $.each(dados, function (index, ponto) {
            map.addMarker({
                ...
                infoWindow: {
                    content: montaJanelaNoMapa(ponto.idProduto, ponto.img, ponto.nomeProduto, ponto.nomeFornecedor, ponto.preco, ponto.modo, ponto.nota)
                }
            });
        });
    });
});
function montaJanelaNoMapa(idProduto, imagem, nomeProduto, nomeUsuario, preco, modoProducao, nota) {
