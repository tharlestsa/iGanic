...
<html lang="pt_br">
    <head>
        ...
        <!-- Bootstrap core CSS -->
        <link href="https://markcell.github.io/jquery-tabledit/assets/css/bootstrap-yeti.min.css" rel="stylesheet">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="foto-modal-title">Upload de fotos</h5>
    ...
    <script type="text/javascript">
        ...
        function abriGerenciadorDeFotos(id) {
            $("#foto-modal").modal();
            $("#frame").attr('src', '../imagem?idProduto=' + id + '&cmd=listar');
        }
