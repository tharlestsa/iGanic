<%-- 
    Document   : rodape
    Created on : 23/11/2017, 21:20:27
    Author     : tharles
--%>
...
<footer class="sticky-footer">
    <div class="container">
        <div class="text-center">
            <small>Copyright © iGanic <script>document.write(new Date().getFullYear())</script> </small>
        </div>
    </div>
</footer>
...
<script src="./template/admin/js/sb-admin.js" type="text/javascript"></script>
